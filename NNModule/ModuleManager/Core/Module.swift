...
@objcMembers public final class Module: NSObject {
    ...
    ///         Module.launchTaskService.addRegister(AModuleLaunchTask.self)
    ///     }
    /// }
...
public extension Module {
    ...
    static func bridge<Service>(method: Selector, of serviceType: Service.Type, used aClass: ModuleRegisteredService.Type) {
    ...
    static func bridge<Service>(classMethod: Selector, of serviceType: Service.Type, used aClass: ModuleRegisteredService.Type) {
...
public extension Module {
    ...
    @objc(registerService:usedClass:)
    /// Register services
    /// - Parameters:
    ...
    @objc(bridgeMethod:ofProtocol:usedClass:)
    /// Bridge a instance method in the service.
    ///
    /// Note:
    ...
    @objc(bridgeClassMethod:ofProtocol:usedClass:)
    /// Bridge a class method in the service.
    ///
    /// Note:
    /// 1. The service need add @objc tag
